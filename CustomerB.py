...
class customer:
    ...
    def __init__(self):
        self.screen_c = Tk()
        self.screen_c.title("Customer Dashboard")
        self.screen_c.geometry("2560x1600")
        ...
        supplier_frm = Frame(self.screen_c, width=2560, height=1800)
        supplier_frm.grid()

        tt_frame = Frame(supplier_frm, bd=2, width=2560, height=10, padx=54, pady=8, bg="Ghost White", relief=RIDGE)
        tt_frame.pack(side=TOP)

        lbltt = Label(tt_frame, text="Customer Data Entry", font=('arial', 20, 'bold'), bg="Ghost White")
        lbltt.grid()
        ...
        datent_frame = LabelFrame(dat_frm, bd=1, width=700, height=1550, bg="SkyBlue3",
                                  relief=RIDGE,
                                  font=('arial', 18, 'bold'), text="Data Entry\n")
        datent_frame.pack(side=LEFT)

        datvis_frame = LabelFrame(dat_frm, bd=1, width=1860, height=1550, bg="SkyBlue3",
                                  relief=RIDGE,
                                  font=('arial', 18, 'bold'), text="Data Visualisation\n")
        datvis_frame.pack(side=RIGHT)

        datgrp_frame = LabelFrame(datvis_frame, bd=1, height=20, bg="SkyBlue3",
                                  relief=RIDGE,
                                  font=('arial', 18, 'bold'), text="Visualisation\n")
        datgrp_frame.pack(side=TOP)

        datlst_frame = LabelFrame(datvis_frame, bd=1, height=10, bg="SkyBlue3",
                                  relief=RIDGE,
        ...
        # Process steps
        self.lblprc = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Process Step (PS):", padx=2,
                            pady=2, width=25)
        ...
        # Circularity Metrics
        self.lblcirc = Label(datent_frame, bg="SkyBlue3", foreground="lavender", font=('arial', 14, 'bold'), text="Circularity Metrics", padx=2,
                             pady=2, width=25)
        self.lblcirc.grid(row=1, column=0)

        self.lblvirmat = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Virgin Material (VM):",
        ...
        self.lblvirmatmt = Label(datent_frame, bg="SkyBlue3", font=('arial', 12), text="kg", padx=2, pady=2, width=10)
        self.lblvirmatmt.grid(row=2, column=2, sticky=W)

        self.lblrecmat = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Recycled Material (REC):",
                               padx=2, pady=2, width=25)
        ...
        self.lblrecmatmt = Label(datent_frame, bg="SkyBlue3", font=('arial', 12), text="kg", padx=2, pady=2, width=10)
        self.lblrecmatmt.grid(row=3, column=2, sticky=W)

        self.lblreumat = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Reused Material (REU):",
                               padx=2, pady=2, width=25)
        ...
        self.lblreumatmt = Label(datent_frame, bg="SkyBlue3", font=('arial', 12), text="kg", padx=2, pady=2, width=10)
        self.lblreumatmt.grid(row=4, column=2, sticky=W)

        self.lblredmat = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Reduced Material (RED):",
                               padx=2, pady=2, width=25)
        ...
        self.lblredmatmt = Label(datent_frame, bg="SkyBlue3", font=('arial', 12), text="kg", padx=2, pady=2, width=10)
        self.lblredmatmt.grid(row=5, column=2, sticky=W)

        self.lblwastemat = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Waste Material (WM):",
                               padx=2, pady=2, width=25)
        ...
        self.lblwastematmt = Label(datent_frame, bg="SkyBlue3", font=('arial', 12), text="kg", padx=2, pady=2, width=10)
        self.lblwastematmt.grid(row=6, column=2, sticky=W)

        # Environmental Metrics
        self.lblenv = Label(datent_frame, bg="SkyBlue3", foreground="lavender", font=('arial', 14, 'bold'), text="Environmental Metrics", padx=2,
                             pady=2, width=25)
        self.lblenv.grid(row=7, column=0)

        self.lblwaterw = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Water Consumption (WT):", padx=2,
                               pady=2, width=25)
        ...
        self.lblwatermt = Label(datent_frame, bg="SkyBlue3", font=('arial', 12), text="m3", padx=2, pady=2, width=10)
        self.lblwatermt.grid(row=8, column=2, sticky=W)

        self.lblfuel = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Fuel (FL):", padx=2,
                               pady=2, width=25)
        ...
        self.lblfuelmt = Label(datent_frame, bg="SkyBlue3", font=('arial', 12), text="kWh", padx=2, pady=2, width=10)
        self.lblfuelmt.grid(row=9, column=2, sticky=W)

        self.lblelect = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Electricity (EL):", padx=2,
                             pady=2, width=25)
        ...
        self.lblelectmt = Label(datent_frame, bg="SkyBlue3", font=('arial', 12), text="kWh", padx=2, pady=2, width=10)
        self.lblelectmt.grid(row=10, column=2, sticky=W)

        self.lbltran = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Transportation (TR):",
                              padx=2,
                              pady=2, width=25)
        ...
        self.lbltranmt = Label(datent_frame, bg="SkyBlue3", font=('arial', 12), text="kWh", padx=2, pady=2, width=10)
        self.lbltranmt.grid(row=11, column=2, sticky=W)

        # Economic Metrics
        self.lblecon = Label(datent_frame, bg="SkyBlue3", foreground="lavender", font=('arial', 14, 'bold'), text="Economic Metrics", padx=2,
                            pady=2, width=25)
        self.lblecon.grid(row=12, column=0)

        self.lblcyc = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Cycle Time (CY):",
                             padx=2,
                             pady=2, width=25)
        ...
        self.lblcycmt = Label(datent_frame, bg="SkyBlue3", font=('arial', 12), text="s", padx=2, pady=2, width=10)
        self.lblcycmt.grid(row=13, column=2, sticky=W)

        self.lblopr = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Operators (OP):",
                            padx=2,
                            pady=2, width=25)
        ...
        self.lbloprmt = Label(datent_frame, bg="SkyBlue3", font=('arial', 12), text="#", padx=2, pady=2, width=10)
        self.lbloprmt.grid(row=14, column=2, sticky=W)

        # Social Metrics
        self.lblsoc = Label(datent_frame, bg="SkyBlue3", foreground="lavender", font=('arial', 14, 'bold'), text="Social Metrics", padx=2,
                            pady=2, width=25)
        self.lblsoc.grid(row=15, column=0)

        self.lblnl = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Noise Level (NL):",
                            padx=2,
                            pady=2, width=25)
        ...
        self.lblnlmt = Label(datent_frame, bg="SkyBlue3", font=('arial', 12), text="db", padx=2, pady=2, width=10)
        self.lblnlmt.grid(row=16, column=2, sticky=W)

        self.lblemp = Label(datent_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Creation of employment (EP):",
                            padx=2,
                            pady=2, width=25)
        ...
        self.lblempmt = Label(datent_frame, bg="SkyBlue3", font=('arial', 12), text="#", padx=2, pady=2, width=10)
        self.lblempmt.grid(row=17, column=2, sticky=W)

        self.lblinfo = Label(datent_frame, bg="SkyBlue3", foreground="lavender", font=('arial', 14, 'bold'), text="Info:", padx=2,
                            pady=2, width=25)
        self.lblinfo.grid(row=18, column=0)

        self.lblinfo1 = Label(datent_frame, bg="SkyBlue3", font=('arial', 12),
                              text="Press \n Add Data", padx=2, pady=2, width=10)
        self.lblinfo1.grid(row=18, column=1)

        self.lblinfo2 = Label(datent_frame, bg="SkyBlue3", font=('arial', 12),
                              text="To save", padx=2, pady=2, width=10)
        self.lblinfo2.grid(row=19, column=1)

        self.lblinfo3 = Label(datent_frame, bg="SkyBlue3", font=('arial', 12),
                              text="", padx=2, pady=2, width=10)
        self.lblinfo3.grid(row=20, column=1)

        self.lblinfo4 = Label(datent_frame, bg="SkyBlue3", font=('arial', 12),
                              text="", padx=2, pady=2, width=10)
        self.lblinfo4.grid(row=21, column=1)

        # Graph
        self.lblhd = Label(datgrp_frame, bg="SkyBlue3", font=('arial', 14, 'bold'), text="Metrics for C02 trend lines:",
                           padx=2,
                           pady=2, width=25)
